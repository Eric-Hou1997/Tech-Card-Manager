...
grep -Fq 'const appVersion = "4.0.1"' "$ROOT/windows/main.go"
grep -Fq "\$ManagerVersion = '4.0.1'" "$ROOT/windows/engine/windows-engine.ps1"
grep -Fq 'const WEB_CARD_VERSION = "4.0.1"' "$ROOT/windows/engine/technical-specs-card.js"
...
echo "Tech Card Manager v4.0.1 Windows 发布文件已生成（仅 ZIP）：$OUT/$WIN_ZIP_NAME"
