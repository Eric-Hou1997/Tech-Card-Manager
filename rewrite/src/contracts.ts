...
export type OperationResult = { "kind": "configuration", "result": Configuration } | { "kind": "migration-plan", "result": MigrationPlan } | { "kind": "migration", "result": MigrationReceipt } | { "kind": "task", "result": Task };
