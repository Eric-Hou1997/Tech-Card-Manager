...
- 设置中加入简体中文 / English (United States) 语言选择。4.0.2 暂保持中文界面，为后续语言包保留设置；它不改变 NFO、技术规格或卡片数据。
