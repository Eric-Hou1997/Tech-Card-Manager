...
$ExpectedWebCardVersion = '4.0.0'
$ManagerVersion = '4.0.0'
...
Write-Host ''
Write-Host '✅ Tech Card Manager Windows 4.0.0 Portable 索引引擎启用完成。' -ForegroundColor Green
Write-Host ''
Write-Host 'Tech Card Manager 4.0.0 支持 Portable 数据目录、用户选择媒体目录、目录级扫描与只读 NFO 目录。'
