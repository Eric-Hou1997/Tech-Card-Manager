...
func showTrayMenu(hwnd uintptr) {
	...
	openText, _ := syscall.UTF16PtrFromString(currentNativeLocalized("打开 Tech Card Manager", "Open Tech Card Manager"))
	exitText, _ := syscall.UTF16PtrFromString(currentNativeLocalized("退出 Tech Card Manager", "Exit Tech Card Manager"))
