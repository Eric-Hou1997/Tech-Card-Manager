...
checks = {
    "version triplet": all(x for x in [
        ...
        "$ManagerVersion = '4.0.2'" in engine,
        'const WEB_CARD_VERSION = "4.0.2"' in card,
        "$ExpectedWebCardVersion = '4.0.2'" in engine,
    ]),
...
print("OK Windows v4.0.2: transactional Web Patch, read-only NFO catalog, scoped Web Card")
