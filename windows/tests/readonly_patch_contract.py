...
checks = {
    "version triplet": all(x for x in [
        ...
        "$ManagerVersion = '4.1.0'" in engine,
        'const WEB_CARD_VERSION = "4.1.0"' in card,
        "$ExpectedWebCardVersion = '4.1.0'" in engine,
    ]),
...
print("OK Windows v4.1.0: transactional Web Patch, read-only NFO catalog, scoped Web Card")
