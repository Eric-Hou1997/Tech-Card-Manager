...
checks = {
    "version triplet": all(x for x in [
        'const appVersion = "4.0.0"' in main,
        "$ManagerVersion = '4.0.0'" in engine,
        'const WEB_CARD_VERSION = "4.0.0"' in card,
        "$ExpectedWebCardVersion = '4.0.0'" in engine,
    ]),
...
print("OK Windows v4.0.0: transactional Web Patch, read-only NFO catalog, scoped Web Card")
