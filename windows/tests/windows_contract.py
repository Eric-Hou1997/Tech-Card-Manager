...
checks={
 ...
 'card v4.0.4':'const WEB_CARD_VERSION = "4.0.4"' in card,
 ...
 'windows card version':"$ExpectedWebCardVersion = '4.0.4'" in win,
 ...
 'Edge app window receives TCM taskbar icon':'procSendMessage' in tray and 'wmSetIcon' in tray and 'applyManagerWindowIcon(hwnd)' in tray,
